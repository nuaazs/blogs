...
平衡二叉树是采用**二分法思维把数据按规则组装成一个树形结构的数据**，用这个树形结构的数据减少无关数据的检索，大大的**提升了数据检索的速度**；平衡二叉树的数据结构组装过程有以下规则：

（1）非叶子节点只能允许最多两个子节点存在。

（2）每一个**非叶子节点数据分布规则为左边的子节点小当前节点的值，右边的子节点大于当前节点的值**(这里值是基于自己的算法规则而定的，比如hash值)；



![img](https://pic3.zhimg.com/80/v2-28e39093993f673de576f57ea614d604_720w.jpg)
...
![img](https://pic1.zhimg.com/80/v2-2b52d4e523f374f41b5429cd587443db_720w.jpg)
...
![img](https://pic3.zhimg.com/80/v2-2c2264cc1c6c603dfeca4f84a2575901_720w.jpg)
...
![img](https://picb.zhimg.com/80/v2-e1d65c9c6236d4768c89e8e103e12583_720w.jpg)



再插入23、29

![img](https://pic3.zhimg.com/80/v2-66cdb6187cbc5227fd8c4aabe7282e6c_720w.jpg)



再插入50、28

![img](https://pic3.zhimg.com/80/v2-3057eaab2b1764dd51c2a8658791cc98_720w.jpg)
...
![img](https://picb.zhimg.com/80/v2-a0f981fc847772cb28869927cd4fe66d_720w.jpg)
...
![img](https://pic2.zhimg.com/80/v2-5f069fd820637db1b877fdd6799a2b67_720w.jpg)
